...
| `/onboard`            | Personalize preference scopes, addons (essentials recommended), locale, release channel |
...
| `/selftest`           | Agent-agnostic selftest — generic checks + a section per detected agent                  |
