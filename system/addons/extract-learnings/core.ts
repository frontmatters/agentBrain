...
import { callModel } from "../youtube-knowledge/src/summarizer";
...
async function loadSettings(): Promise<any> {
  // Reuse the youtube-knowledge summarizer config if present; else empty (Pi fallback).
  const p = join(BRAIN, "local", "addons", "youtube-knowledge", "channels.json");
