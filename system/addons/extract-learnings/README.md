...
The summary model is read from the youtube-knowledge summarizer config
(`local/addons/youtube-knowledge/channels.json` → `settings`) when present, else it
...
1. the summarizer configured in `local/addons/youtube-knowledge/channels.json`
