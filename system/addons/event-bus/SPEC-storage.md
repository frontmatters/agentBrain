...
Per consumer: `vault/events/cursors/<hostname>/<agent>/`
...
Layout: `vault/events/audit/<hostname>/<agent>/<YYYY-MM-DD>.ndjson`
...
> `IMPL`: v0.3 has all of `vault/` gitignored in both repos. Events therefore
...
> - `vault/.gitignore` to opt-out specifically: `!events/inbox/`, `!events/audit/`
