...
> Copy this file to `vault/projects/<project>/war-games/<mission>.md` and fill it in.
> Method: see `vault/learnings/pre-deprecation-wargame-playbook.md` (if present in your vault).
