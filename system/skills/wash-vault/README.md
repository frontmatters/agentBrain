...
# Scope to a sub-tree
bash ~/agentBrain/system/skills/wash-vault/bin/wash-vault --scope ~/agentBrain/vault/learnings
...
- The canonical note schema this enforces: `vault/references/agentbrain-note-schema.md`
- Diagnostic interpretation of wash findings: `vault/learnings/wash-output-as-upstream-diagnostic.md`
