...
Public = HOW/WHERE. Private = WHAT. Save real fixes in `vault/`.

Log a problem + solution in `vault/learnings/troubleshooting.md` so it does not need to be researched again without publishing private discoveries.

## Steps

1. **Read `vault/learnings/troubleshooting.md`** to understand the current structure.
...
## References
- Troubleshooting log: `vault/learnings/troubleshooting.md`
