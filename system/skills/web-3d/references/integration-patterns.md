<!-- PROVENANCE: vendored + sanitized 2026-07-27 from freshtechbro/claudedesignskills · web3d-integration-patterns. Recipe markdown
     only — the source's scaffolding scripts/ were deliberately NOT carried over.
     Owned + maintained here in agentBrain, no upstream dependency. -->
