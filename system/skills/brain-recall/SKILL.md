---
name: brain-recall
description: Restore a forgotten agentBrain note from vault/.trash/forget/. Resolves by timestamp, slug, or number. Triggers — "recall", "undo forget", "restore note", "haal terug uit trash".
---
...
```
brain-recall: conflict at vault/learnings/foo.md — target already exists.
