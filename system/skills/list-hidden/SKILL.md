...
```
#    TYPE         PATH
[1]  learnings    vault/learnings/Foo.md
[2]  projects     vault/projects/bar/index.md

#    BATCH               ORIGINAL PATHS    (with --include-trash)
[3]  20260603-153012     vault/learnings/Old.md
```
...
Writes `~/agentBrain/vault/.hidden-index.json` for `<N>` resolution. Overwrites on every run.
