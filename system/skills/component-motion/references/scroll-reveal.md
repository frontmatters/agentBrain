<!-- PROVENANCE: vendored + sanitized 2026-07-27 from freshtechbro/claudedesignskills · scroll-reveal-libraries. Recipe content
     only (the source's SKILL.md); no scripts / eval / network / install-hooks
     carried over. Owned + maintained here in agentBrain. -->
