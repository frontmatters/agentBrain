<!-- PROVENANCE: vendored 2026-08-04 from lottiefiles/motion-design-skill (MIT, © LottieFiles).
     Library-agnostic motion-design theory. Recipe markdown only — no scripts/eval/network/install-hooks.
     Point-in-time snapshot, not live-synced. Owned + maintained here in agentBrain. -->
