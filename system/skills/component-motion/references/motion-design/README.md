...
date: 2026-08-04
type: reference
tags: [skill, motion, motion-design, theory, vendored]
id: 88bd5974-7963-5283-9685-97d7183274ec
---

<!-- PROVENANCE: vendored 2026-08-04 from lottiefiles/motion-design-skill (MIT, © LottieFiles).
     This is the source skill's SKILL.md cheatsheet, re-homed as the library-agnostic
     "director" layer for [[component-motion]]. Recipe markdown only — no scripts/eval/
     network/install-hooks. Point-in-time snapshot, not live-synced. Owned + maintained here. -->

# Motion Design — director layer (library-agnostic)

The *why / how-should-it-feel* layer for [[component-motion]]. Read this to decide
**emotional intent, personality, timing, easing, and choreography** BEFORE picking a
library in `../../SKILL.md`. Deep dives live in `director/`, `patterns/`, `reference/`.
