---
name: brain-retro
description: Run a structured retrospective over agentBrain itself: system, extensions, add-ons, backlog, and knowledge hygiene. Use monthly or after major framework changes.
