---
name: brain-forget
description: Soft-delete an agentBrain note to vault/.trash/forget/. Default prompts for confirmation (--force to skip), shows backlinks pre-flight warning. Recoverable via /brain-recall. Triggers — "forget this", "soft-delete", "weggooien", "remove note".
---

# brain-forget — soft-delete a note via central trash

Moves a note to `vault/.trash/forget/<timestamp>/`. Reversible via [[brain-recall]].
