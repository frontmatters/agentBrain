...
Moves a note to `vault/.trash/forget/<timestamp>/` so it disappears from `find`, `grep`, and listings without being permanently lost. Confirmation prompt by default; warns on backlinks.
