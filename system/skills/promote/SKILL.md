...
name: promote
description: >-
  Move artifacts between mirror subfolders in agentBrain — vault/X/ ↔ system/X/
...
bash bin/promote $BRAIN_DIR/vault/skills/yt-digest
...
are tracked in `vault/projects/promote-demote-skill/index.md` backlog, plus:
