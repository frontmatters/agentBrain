...
`vault/research/repo-distill/<slug>/` and the UUID5 seeds of all distillates,
...
Expected output:
- Workspace: `~/agentBrain/vault/research/repo-distill/<slug>/`
...
NEW_UUID=$(bash ~/agentBrain/scripts/uuid5-gen.sh \
   "vault/research/repo-distill/<slug>/DISTILLATE/<basename>")
...
`~/agentBrain/vault/learnings/scanman/scanman-v0-6-execution-<date>-<repo>.md`
...
- `~/agentBrain/vault/research/repo-distill/scanman-v0-6-template-empirical-validation-2026-05-31` — design research note
- `~/agentBrain/vault/research/repo-distill/scanman-handover-2026-05-31` — predecessor session
