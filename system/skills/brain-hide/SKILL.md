---
name: brain-hide
description: Hide an agentBrain note from listings without deleting it. Adds `hidden: true` + `hidden-at` to frontmatter. Use when a learning, project, or preference no longer needs to clutter /list-* output but you want to keep it around. Triggers — "hide this note", "verstop", "uit zicht halen", "remove from listings".
---
