...
SKILL_DIR="$AGENTBRAIN_DIR/vault/skills/peer-review"
STATE_DIR="$SKILL_DIR/state"
INVOCATIONS_LOG="$STATE_DIR/invocations.log"
REVIEWS_DIR="$AGENTBRAIN_DIR/vault/reviews"
...
if [ "$should_archive" -eq 1 ]; then
	...
	archive_uuid5="$(bash "$AGENTBRAIN_DIR/scripts/uuid5-gen.sh" "vault/reviews/$archive_basename" 2>/dev/null || echo "")"
	{
		echo "---"
