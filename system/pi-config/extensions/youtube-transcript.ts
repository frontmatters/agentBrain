...
function registerDownloadTool(pi: ExtensionAPI): void {
	pi.registerTool({
		...
		description:
			"Download a YouTube transcript via yt-dlp subtitles, convert VTT to deduplicated plain text, and optionally save markdown to agentBrain/local/youtube-knowledge. Does not download audio or run Whisper.",
		promptSnippet:
