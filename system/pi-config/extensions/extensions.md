...
| `voice.ts`              | `/voice` command — launches the agentBrain voice addon entrypoints      | `registerCommand`                                                                                         |
...
| `pi.on("tool_result", ...)`               | `pi-cloak/index.ts`                                          | `ExtensionAPI.on`                   |
| `pi.on("tool_call", ...)`                 | `git-interceptor.ts`                                         | `ExtensionAPI.on`                   |
