...
| `pi.registerTool()`                       | `agentbrain.ts`, `youtube-transcript.ts`, `zsh-user-bash.ts`, `goal.ts` | `ExtensionAPI.registerTool`         |
...
| `pi.on("before_agent_start", ...)`        | `agentbrain.ts`, `goal.ts`                                   | `ExtensionAPI.on`                   |
| `pi.on("agent_settled", ...)`             | `goal.ts`                                                    | `ExtensionAPI.on`                   |
| `pi.appendEntry()`                          | `goal.ts`                                                    | `ExtensionAPI.appendEntry`          |
