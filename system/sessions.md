...
- **UUID5**: full UUID in frontmatter `id` field, generated from the final archive path, including PID: `scripts/uuid5-gen.sh "vault/sessions/archive/YYYY-MM/YYYYMMDD-HHMMSS-<pid>"`
