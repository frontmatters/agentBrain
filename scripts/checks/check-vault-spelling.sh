...
RE_COMMENT='^[[:space:]]*#'
RE_IDENTITY='uuid5-gen\.sh|validate-note-id|validate-staged-note-ids'
is_path_use() {
	local l="$1"
...
--count)
	...
	#   - the alias mechanics (setup-local-vault, setup-structure, migrate-v2,
