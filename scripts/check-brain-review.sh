...
skip_segments = {'youtube-digest', 'daily-notes', 'sessions', 'setup-history', 'templates', 'quarantine', 'archive'}
...
if scope in ('all', 'public'):
    ...
    public_dirs = ['learnings', 'projects', 'system', 'templates', 'sessions', 'daily-notes', 'user-preferences', 'youtube-digest']
...
if scope in ('all', 'public'):
    for d in ['learnings', 'projects', 'system', 'templates', 'user-preferences', 'sessions', 'daily-notes', 'youtube-digest']:
        if os.path.isdir(d):
