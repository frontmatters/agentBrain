...
usage() {
  echo "Usage:" >&2
  echo "  bash scripts/scanman/scanman-release.sh check" >&2
  echo "  bash scripts/scanman/scanman-release.sh current" >&2
  echo "  bash scripts/scanman/scanman-release.sh release <0.0.x>" >&2
}
