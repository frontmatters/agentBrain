...
. "$ROOT_DIR/scripts/platform.sh" 2>/dev/null || . "$(dirname "$0")/platform.sh"
# shellcheck source=scripts/capability-install.sh
. "$ROOT_DIR/scripts/capability-install.sh" 2>/dev/null || . "$(dirname "$0")/capability-install.sh"
