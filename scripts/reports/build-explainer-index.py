...
the main vault (vault/explainers) plus every sealed space (vault/spaces/*/explainers).
...
excluded from search. Output: vault/explainers/index.html.

Run standalone: python3 scripts/reports/build-explainer-index.py
